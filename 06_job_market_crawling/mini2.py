...
try:
    ...
    # 2. '빅데이터·AI' 클릭
    ai_btn = wait.until(EC.element_to_be_clickable((By.XPATH, "//span[text()='빅데이터·AI']")))
...
df = pd.DataFrame(catch_dict)
print(tabulate(df, headers='keys', tablefmt='grid'))
df.to_csv('catch3.csv',index=False)